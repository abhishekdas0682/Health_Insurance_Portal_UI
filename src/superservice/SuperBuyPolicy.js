...
import BuyForReal from './BuyForReal';
//import CustomerBuyPolicy from '../customerservice/CustomerBuyPolicy'
...
export class SuperBuyPolicy extends Component {
    constructor(){
        super();
        this.state = {
