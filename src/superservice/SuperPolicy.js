...
import { Input, FormGroup, Label, Modal, ModalHeader, ModalBody, ModalFooter, Table, Button, Form } from 'reactstrap';
...
class SuperPolicy extends Component {
    state = {
        policies: [],
        filtered: [],
            ...
            <div className="App__container">
                ...
                <Modal isOpen={this.state.editPolicyModal} toggle={this.toggleEditPolicyModal.bind(this)}>
                    ...
                    <ModalBody>
                        <FormGroup>
                            ...
                            <Input id="plan_id" placeholder="" value={this.state.editPolicyData.plan_id} onChange={(e) => {
                ...
                <Modal isOpen={this.state.ddeletePolicyModal} toggle={this.toggleDeletePolicyModal.bind(this)}>
                    ...
                    <ModalBody>
                        <FormGroup>
                            <Label for="plan_id">Plan ID</Label>
                            <Input id="plan_id" placeholder="" value={this.state.ddeletePolicyData.plan_id} onChange={(e) => {
